...
parser.add_argument('--overwrite', action='store_true', default=False, help='overwrite the previous saved model')
    ...
    for ii in range(args.itr):
        ...
        if not args.overwrite:
            if os.path.exists(os.path.join('results', setting)):
                print('Experiment {} already exists. Skipping training.'.format(setting))
                continue
